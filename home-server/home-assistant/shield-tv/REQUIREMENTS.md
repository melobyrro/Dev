# Shield TV Dashboard - Functional Requirements

## Dashboard Information
- **Dashboard ID**: ``shield_tv``
- **Title**: Shield TV
- **URL Path**: ``/shield-tv``
- **Configuration Location**: ``/mnt/ByrroServer/docker-data/homeassistant/config/.storage/lovelace.shield_tv``
- **Last Updated**: 2026-01-12

## Functional Requirements

### 1. Dashboard Display Requirements
- The dashboard shall display 1 entities across 1 different entity types
...
- **Media Player Management**: Users shall be able to monitor and interact with 1 media_player entities
...
|-------------|-------|-------------|
| Media Player | 1 | Integration |
| **Total** | **1** | |

### Entity Details with Source References

#### Media Player Entities (1)
...
1. **Dashboard Configuration**: ``/mnt/ByrroServer/docker-data/homeassistant/config/.storage/lovelace.shield_tv``
